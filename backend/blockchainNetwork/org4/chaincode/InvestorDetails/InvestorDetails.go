...
type InvestorDetailsChaincode struct {
}
...
func (cc *InvestorDetailsChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *InvestorDetailsChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *InvestorDetailsChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *InvestorDetailsChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *InvestorDetailsChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *InvestorDetailsChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *InvestorDetailsChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *InvestorDetailsChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(InvestorDetailsChaincode))
	if err != nil {
