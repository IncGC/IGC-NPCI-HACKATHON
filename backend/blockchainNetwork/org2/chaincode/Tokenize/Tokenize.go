...
type Tokenize struct {
	...
	NoOfTokenizes   string    `json:"NoOfTokenizes"`
	TokenizeValue   string    `json:"TokenizeValue"`
}

func (cc *TokenizeChaincode) create(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
	...
	data := Tokenize{
		...
		yield:        args[10],
		Currency:     args[11],
		NoOfTokenizes:   args[12],
		TokenizeValue:   args[13],
	}
...
func (cc *TokenizeChaincode) get(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *TokenizeChaincode) update(stub shim.ChaincodeStubInterface, arg []string) peer.Response {
...
func (cc *TokenizeChaincode) delete(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *TokenizeChaincode) history(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *TokenizeChaincode) querystring(stub shim.ChaincodeStubInterface, args []string) peer.Response {
...
func (cc *TokenizeChaincode) Init(stub shim.ChaincodeStubInterface) peer.Response {
	return shim.Success(nil)
}

func (cc *TokenizeChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
func main() {
	...
	err := shim.Start(new(TokenizeChaincode))
	if err != nil {
